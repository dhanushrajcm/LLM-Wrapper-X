...
# os.environ["GROQ_API_KEY"] = "your-api-key-here"  # Uncomment and set if using an environment variable
...
def LLM_QnA_agent(prompt, temperature=1.0, max_tokens=1024):
    """
    Function to interact with Groq API using the Gemma2-9b-it model for chat completions.
